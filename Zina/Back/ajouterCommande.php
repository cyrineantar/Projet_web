...
function validateForm() {
  ...
  var prix_total= document.forms["myForm"]["prix_total"].value;
    var id_client = document.forms["myForm"]["id_client"].value;
    var id_livraison = document.forms["myForm"]["id_livraison"].value;
  ...
  if (id_commande== "") {
    alert("id_commande vide");
    return false;
  }
  if (id_commande == 0) {
    alert("id_commande ne peut pas etre null");
    return false;
  }
    if (id_client == "") {
    alert("id_client vide");
    return false;
  }
    
    if (id_livraison == "") {

    alert("id_livraison vide");
    return false;
  }
