  ...
  <section id="container" class="">
    ...
    <section id="main-content">
      <section class="wrapper">
        <div class="row">
          <div class="col-lg-12">
            <h3 class="page-header"><i class="fa fa-files-o"></i>Ajouter Evenements</h3>
            <ol class="breadcrumb">
              <li><i class="fa fa-home"></i><a href="index.html">Home</a></li>
              <li><i class="icon_document_alt"></i>Gestion des Evenements</li>
              <li><i class="fa fa-files-o"></i>Ajouter Evenements</li>
            </ol>
          </div>
        </div>
    <!--main content start-->
    <button><a href="afficherEven.php">Retour à la liste</a></button>
        ...
        <form action="ajouterEven.php" method="POST">
            <table border="1" align="center">
                ...
                <tr>
                    ...
                    <td><input type="text" name="nom_even" id="nom_even" maxlength="20"></td>
                </tr>
                <tr>
                    <td>
                ...
                <tr>
                    ...
                    <td><input type="text" name="localisation" id="localisation" maxlength="20"></td>
                </tr>
                ...
                <tr>
                    ...
                    <td><input type="number" name="id_catg_even" id="id_catg_even" maxlength="20"></td>
                </tr>
