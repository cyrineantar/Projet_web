		...
		<div class="col-md-6 portlets">
            <div class="panel panel-default">
              <div class="panel-heading">
                <div class="pull-left">Ajout Client</div>
              ...
              <div class="panel-body">
                ...
                <div class="form-group">
                        <label  class="control-label col-lg-2" for="tags">Nom:</label>
						<div class="col-lg-10">
                        <input type="text" class="form-control" id="tags" id_client="nom_client" maxlength="20"></div>
                        </div>
                      </div>
				<div class="form-group">
                        <label  class="control-label col-lg-2" for="tags">Prenom:</label>
						<div class="col-lg-10">
                        <input type="text" class="form-control" id="tags" id_client="prenom_client" maxlength="20"></div>
                        </div>
                      </div>	  
                <div class="form-group">
                        <label  class="control-label col-lg-2" for="tags">Num:</label>
						<div class="col-lg-10">
                        <input type="number" class="form-control" id="tags" id_client="num_client" maxlength="20"></div>
                        </div>
                      
                <div class="form-group">
                        <label  class="control-label col-lg-2" for="tags">Adresse:</label>
						<div class="col-lg-10">
                        <input type="text" class="form-control" id="tags" id_client="adresse_client" maxlength="20"></div>
                        </div>
                <div class="form-group">
                        <label  class="control-label col-lg-2" for="tags">Carte_fidelite:</label>
						<div class="col-lg-10">
                        <input type="text" class="form-control" id="tags" id_client="carte_fidelite" maxlength="20"></div>
                        </div>
                      
                <div class="form-group">
                        <label  class="control-label col-lg-2" for="tags">Id_admin:</label>
						<div class="col-lg-10">
                        <input type="number" class="form-control" id="tags" id_client="id_admin" maxlength="20"></div>
                        </div>
                        <div class="form-group">
                        <!-- Buttons -->
