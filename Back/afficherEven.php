  ...
  <section id="container" class="">
    ...
    <section id="main-content">
      <section class="wrapper">
        <div class="row">
          <div class="col-lg-12">
            <h3 class="page-header"><i class="fa fa-files-o"></i>Afficher Evenements</h3>
            <ol class="breadcrumb">
              <li><i class="fa fa-home"></i><a href="index.html">Home</a></li>
              <li><i class="icon_document_alt"></i>Gestion des Evenements</li>
              <li><i class="fa fa-files-o"></i>Afficher Evenements</li>
            </ol>
          </div>
        </div>
    <!--main content start-->
    <button><a href="Even.html">Ajouter un evenement</a></button>
		...
		<table border=1 align = 'center'>
			...
			?>
					...
					<td>
						<a href="modifierEven.php?id_even=<?PHP echo $even['Id_even']; ?>"id_even="id_even" name="id_even"> Modifier </a>
					</td>
				</tr>
			<?PHP
				}
