  ...
  <section id="container" class="">
    ...
    <section id="main-content">
      <section class="wrapper">
        <div class="row">
          <div class="col-lg-12">
            <h3 class="page-header"><i class="fa fa-files-o"></i>Clients</h3>
            <ol class="breadcrumb">
              <li><i class="fa fa-home"></i><a href="index.html">Home</a></li>
              <li><i class="icon_document_alt"></i>Gestion des Clients</li>
              <li><i class="fa fa-files-o"></i>Afficher Client</li>
            </ol>
          </div>
        </div>
    <!--main content start-->
    <button><a href="ajouterClient.php">Ajouter un Client</a></button>
		...
		<input type="text" id="myInput" onkeyup="myFunction()" placeholder="Rechercher" title="type in a name"
			...
			?>
					...
					<td>
						<a href="modifierClient.php?Id_client=<?PHP echo $Client['Id_client']; ?>" Id_client="Id_client" name="Id_client" > Modifier </a>
					</td>
				</tr>
