...
// Echo session variables that were set on previous page
    ...
    <section id="main-content">
      <section class="wrapper">
        <div class="row">
          <div class="col-lg-12">
            <h3 class="page-header"><i class="fa fa-files-o"></i>Admins</h3>
            <ol class="breadcrumb">
              <li><i class="fa fa-home"></i><a href="index.html">Home</a></li>
              <li><i class="icon_document_alt"></i>Gestion des Admins</li>
              <li><i class="fa fa-files-o"></i>Afficher Admin</li>
            </ol>
          </div>
        </div>
        <!-- Form validations -->
		...
		<input type="text" id="myInput" onkeyup="myFunction()" placeholder="Rechercher" title="type in a name">
			...
			?>
					...
					<td>
						<a href="modifierAdmin.php?Id_admin=<?PHP echo $admin['Id_admin']; ?>" Id_admin="Id_admin" name="Id_admin" > Modifier </a>
					</td>
				</tr>
			<?PHP
				}
		...
		<a href="imprimerAdmin.php?Id_admin=<?PHP echo $admin['Id_admin']; ?>" Id_admin="Id_admin" name="Id_admin" > Imprimer </a>
                </div>
