  ...
  <section id="container" class="">
    ...
    <section id="main-content">
      <section class="wrapper">
        <div class="row">
          <div class="col-lg-12">
            <h3 class="page-header"><i class="fa fa-files-o"></i>Ajouter Categories</h3>
            <ol class="breadcrumb">
              <li><i class="fa fa-home"></i><a href="index.html">Home</a></li>
              <li><i class="icon_document_alt"></i>Gestion des Categories</li>
              <li><i class="fa fa-files-o"></i>Ajouter Categories</li>
            </ol>
          </div>
        </div>
    <!--main content start-->
        ...
        <form action="ajoutCategorie.php" method="POST">
            <table border="1" align="center">
                ...
                <tr>
                    ...
                    <td><input type="text" name="nom_catg_even" id="nom_catg_even" maxlength="20"></td>
                </tr>
                <tr>
                    <td>
                    ...
                    <td><input type="text" name="type_catg_even" id="type_catg_even" maxlength="20"></td>
                </tr>
