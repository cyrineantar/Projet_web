<?php
	...
	if (
		...
		if (
            ...
            header('refresh:0;url=afficherAdmin.php');
        }
        else
...
<!--sidebar start-->
    ...
    <section id="main-content">
      <section class="wrapper">
        <div class="row">
          <div class="col-lg-12">
            <h3 class="page-header"><i class="fa fa-files-o"></i>Modifier Admins</h3>
            <ol class="breadcrumb">
              <li><i class="fa fa-home"></i><a href="index.html">Home</a></li>
              <li><i class="icon_document_alt"></i>Gestion des Admins</li>
              <li><i class="fa fa-files-o"></i>Modifier Admin</li>
            </ol>
          </div>
        </div>
    <!--main content start-->
    ...
    <button><a href="afficherAdmin.php">Retour à la liste</a></button>
		...
		<form action="" method="POST">
            <table align="center">
                ...
                <tr>
                    <td>
                        <label for="mot_de_passe">mot_de_passe:
                        </label>
                    </td>
